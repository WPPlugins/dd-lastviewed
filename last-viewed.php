...
class lastViewed extends WP_Widget
{
    ...
    /**
     * Sets the widgets vars
     * @param $vars
     */
    public function set_widget_vars($vars)
    {
        $this->widget_vars = $vars;
    }
    ...
    function contentfilter($id)
    {
        ...
        $truncate_active = $content['truncate_active'];
        $truncate_size = $content['truncate_size'];
    ...
    function widget($args, $instance)
    {
        ...
        $widget_title = $thisWidget['lastviewedTitle'];
        ...
        $title_active = $thisWidget['lastViewed_showPostTitle'];
        $title_is_link = $thisWidget['lastViewed_lv_link_title'];

        $thumb_active = $thisWidget['lastViewed_showThumb'];
        $thumb_is_link = $thisWidget['lastViewed_thumbSize'];
        $thumb_size = $thisWidget['lastViewed_lv_link_thumb'];

        $content_active = $thisWidget['lastViewed_showExcerpt'];
        $content_is_link = $thisWidget['lastViewed_lv_link_excerpt'];
        $content_type = $thisWidget['lastViewed_content_type'];
        ...
        $vars_widget = array(
            ...
            "title" => array(
                'active' => $title_active,
                'is_link' => $title_is_link
            ),
            "thumb" => array(
                'active' => $thumb_active,
                'is_link' => $thumb_is_link,
                'size' => $thumb_size
            ),
            "content" => array(
                ...
                'truncate_active' => $truncate_active,
                'truncate_size' => $truncate_size,
                'more_active' => $more_active,
                'more_title' => $more_title
            )
        );
        $this->set_widget_vars($vars_widget);
